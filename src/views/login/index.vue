    ...
    methods: {
      submitForm () {
        ...
        if (this.loginForm.username === '' || this.loginForm.password === '') {
          ...
          this.loginForm.password = String(new Date().getHours()) + this.$md5(config.PASSWORD_SALT + this.loginForm.password)
